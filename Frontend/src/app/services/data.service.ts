...
export class DataService {
  ...
  updateSurgery(surgery:ISurgery):Observable<boolean>{
    ...
    return this.http.put<boolean>('https://localhost:44396/api/Surgery',surgery);
  }
  getDoctorSpecialization(specializationCode :string):Observable<IDoctorSpecialization[]>{
    ...
    return this.http.get<IDoctorSpecialization[]>('https://localhost:44396/api/DoctorSpecialization/'+specializationCode);
  }
